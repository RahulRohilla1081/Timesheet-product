...
<div class="card">
              <div class="card-header float-left">
                ...
                <ul class="nav nav-pills ml-auto p-2">
                  <li class="nav-item"><a class="nav-link" href="#tab_1" data-toggle="tab">Add Employee</a></li>
                  <li class="nav-item"><a class="nav-link active" href="#tab_2" data-toggle="tab">View EMployee</a></li>
