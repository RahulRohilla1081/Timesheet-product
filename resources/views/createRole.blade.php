...
<nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./createRole" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create Role</p>
                </a>
              </li>
 ...
 <div class="card">
   ...
   <label>     
                ...
                <h3 class="card-title">Create Role</h3>
                  ...
                  <form action="{{route('createRole.store')}}" method="POST" class="form-horizontal" style="font-size:15px;">
                  @csrf
                      <div class="card-body">
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Role name</label>
                    <div class="col-sm-10">
                      <input type="text" name="ROLE_NAME" class="form-control" id="inputEmail3" placeholder="Role  Name">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Role Description</label>
                    <div class="col-sm-10">
                      <input type="text" name="ROLE_DESCRIPTION" class="form-control" id="inputPassword3" placeholder="Role Description">
                    </div>
                  </div>
                  <div class="form-group row">
                     <label for="inputPassword3" class="col-sm-2 col-form-label">Authorization</label>
                        
                    <div class="col-sm-10">
                      
                      <select name="AUTH_ID " aria-controls="example1" class="form-control" >
                        <option value="">Select Screen </option>
                        @foreach($screen as $item)
                        <option > {{$item['AUTH_NAME']}} </option>
                             @endforeach
                      </select>
                    </div>
                  </div>
