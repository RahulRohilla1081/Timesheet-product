               ...
               <td>  <div class="row"><div class="col-sm-12 col-md-6">
                ...
                <h3 class="card-title">Create Role</h3>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" placeholder="Role Name">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Role Description</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputPassword3" placeholder="Role Description">
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      ...
                      <select name="example1_length" aria-controls="example1" class="form-control" >
                        <option>Select Authorization</option>
                         <option>Authorization 1</option>
                         <option>Authorization 2</option>
                          <option>Authorization 3</option>
                      </select>
                    </div>
                  </div>
