  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
       ...
       <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Add Employee</a>
      </li>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th style="width: 25%">Employee Full Name</th>
                    <th style="width: 30%">Employee Email</th>
                    <th style="width: 20%">Employee Designation</th>
                    <th style="width: 30%">Manager Name</th>
                    <th style="width: 30%">Manager Email</th>
                  </tr>
                  </thead>
                  <tbody>
                  <tr>
